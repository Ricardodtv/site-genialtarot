...
| `produtos.js` | **A lista de produtos da loja** — o ALBERTO edita este ficheiro (instruções lá dentro, campo a campo). Fotos: subir o ficheiro da imagem ao GitHub e escrever o nome no campo `foto` |
